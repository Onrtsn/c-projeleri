    ...
    public partial class cariborc : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT "+
                            ...
                            "CASE WHEN MUHASEBEFIS.TUR = 'ALIS' OR MUHASEBEFIS.TUR = 'SATIS' THEN MUHASEBEFIS.GENELTOPLAM ELSE 0 END as ALACAK, " +
                            "CASE WHEN MUHASEBEFIS.TUR = 'ODEME' THEN MUHASEBEFIS.GENELTOPLAM ELSE 0 END as BORC " +
                            "FROM MUHASEBEFIS " +
            ...
            var query1 = "select " +
                        "CARI.UNVAN as CARIUNVANI, " +
                        "FAT.GENELTOPLAM as ALACAK, " +
                        "MAH.GENELTOPLAM as BORC, " +
                        "MAH.GENELTOPLAM - FAT.GENELTOPLAM as BAKIYE " +
                        "from CARI " +
                        "OUTER APPLY(SELECT SUM(GENELTOPLAM) as GENELTOPLAM FROM MUHASEBEFIS WHERE CARI.CARIID = CARI AND TUR = 'ALIS') as FAT " +
